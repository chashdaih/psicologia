...
<section class="section">
    <div class="container">
        ...
        <form @if($ecpr->id)
            ...
            <date-component label="Fecha en que se llenó el documento" name="created_at" old="{{old('created_at', $ecpr->created_at)}}"></date-component>
                ...
                <div class="control">
                    <div class="select">
                        <select name="semester">
                            ...
                            <option value="{{ $key }}" @if($key==old('semester', $ecpr->semester)) selected="selected" @endif
                                >{{ $value }}</option>
                            @endforeach
                        </select>
                    </div>
            ...
            <div class="control">
                <div class="select">
                    <select name="evaluation_phase">
                        ...
                        <option value="{{ $key }}" @if($key==old('evaluation_phase', $ecpr->evaluation_phase)) selected="selected" @endif
                            >{{ $value }}</option>
                        @endforeach
                    </select>
                </div>
            ...
            <table class="table is-fullwidth is-hoverable is-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>{{$question}}</td>
                        <td>
                            <numeric-input name="{{'q'.str_replace('.', '', strstr($question, ' ', true))}}" value="{{old('q'.str_replace('.', '', strstr($question, ' ', true)), $ecpr->{'q'.str_replace('.', '', strstr($question, ' ', true))})}}" />
                        </td>
                    </tr>
                    @endforeach
                </tbody>
