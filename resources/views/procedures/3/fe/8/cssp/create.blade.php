...
<section class="section">
    <div class="container">
        ...
        <form
        @if($process_model->id)
        action="{{ route('cssp.update',  ['program'=>$program->id_practica, 'patient'=>$patient->id, 'id'=>$process_model->id]) }}"
        @else
        action="{{ route('cssp.store',  ['program'=>$program->id_practica, 'patient'=>$patient->id]) }}"
        @endif
        method="POST">
